 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "oakland.edu", ownerName = "oakland.edu", packagePath="cse480tester"))
...
public class MessageEndpoint {
   ...
   */
  private static final String API_KEY = "AIzaSyDWelUKxAQGHwD5uILtILtxq6SZl0NxnXk";

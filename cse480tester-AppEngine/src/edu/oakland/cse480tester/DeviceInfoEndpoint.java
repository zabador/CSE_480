...
import edu.oakland.cse480tester.EMF;
...
@Api(name = "deviceinfoendpoint", namespace = @ApiNamespace(ownerDomain = "oakland.edu", ownerName = "oakland.edu", packagePath = "cse480tester"))
